...
<body onLoad="document.getElementById('country').focus();">
    <form action="savesales.php" method="post">
        <div id="ac">
            <center>
                <h4><i class="icon icon-mobile-phone icon-large"></i> Mobile Money Checkout </h4>
            </center>
            <hr>
            ...
            <center>
                 <select type='text' name="transaction_type" style="width:278px;" class="chzn-select" required>
...
<button class="btn btn-success btn-block btn-large" style="width:267px;"><i class="icon icon-check icon-large"></i>
                    Pay</button>
            </center>
        </div>
    </form>
