        ...
        <div class="row-fluid">
                ...
                <div class="well sidebar-nav">
                    <ul class="nav nav-list">
                        ...
                        <li><a href="sales.php?id=cash&invoice=<?php echo $finalcode ?>"><i
                                ...
                                Sales</a> </li>
                        <li class="active"><a href=" products.php"><i class="icon-list-alt icon-2x" style="color:blue"></i> Products</a>
                        </li>
            ...
            <div class="span10">
              ...
              <tr>
                ...
                <th colspan="1" style="border-top:1px solid #999999"><b>Ksh.  <?php echo formatMoney($total_value,true);?>
                </b> </th>
                </tr>
                </thead>
                </table>
