    ...
    <div class="container-fluid">
        <div class="row-fluid">
                ...
                <div class="well sidebar-nav">
                    <ul class="nav nav-list">
                        ...
                        <li class="active"><a href="sales.php?id=cash&invoice"><i
                                    class="icon-shopping-cart icon-2x"></i> Sales</a>
                        </li>
                    ...
                    <div style="margin: 0 auto; padding: 20px; width: 400px; font-weight: normal;">
                        <div style="width: 100%; height: 190px;">
                            <div style="float: left;">
                                <center>
                                    <div style="width:400px; font:bold 20px 'Aleo';"> Honeywell Liquor Store</div>
                            ...
                            <div style="float: left;">
                                <table cellpadding="5" cellspacing="0"
                                    ...
                                    <tr>
                                        ...
                                        <td>Date :<?php echo date("d/m/Y  h:s") ?></td>
                                    </tr>
                                </table>
                        ...
                        <div style="width: 100%; margin-top:-70px;">
                            ...
                            <center style="font-size:12px">
                                <div>Mpesa Till: 5209399</div>Good onces sold are not refundable
                            </center>
            ...
            <div class="pull-right" style="margin-right:100px;">
                <a href="javascript:Clickheretoprint()" id=style="font-size:20px;"><button
                        class="btn btn-success btn-large printbtn"><i class="icon-print"></i> Print</button></a>
            </div>
        </div>
    </div>