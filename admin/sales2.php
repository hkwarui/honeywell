                ...
                <div class="well sidebar-nav">
                    <ul class="nav nav-list">
                        ...
                        <li><a href=" supplier.php"><i class="icon-group icon-2x" style="color:yellow"></i>
                                Suppliers</a> </li>
                        <li><a href=" salesreport.php?ss"><i class="icon-bar-chart icon-2x"></i> Sales
                                Report</a> </li>
                            ...
                            <div class="hero-unit-clock">
                                ...
                                <form name="clock">
                                    <font color="white">Time: <br></font>&nbsp;<input style="width:150px;color:#00B294;"
                                        type="text" class="trans" name="face" value="" disabled>
                                </form>
                            </div>
                        </li>
...
for ($i = 0; $row = $result->fetch(); $i++) {
    ?>
                        <option value="<?php echo $row['product_id']; ?>"><?php echo $row['product_code']; ?> -
                            <?php echo $row['gen_name']; ?> - <?php echo $row['product_name']; ?> :
                            <?php echo $row['qty'] ?></option>
                        <?php  $maxValue=$row['qty']; } ?>
                    </select>
                    <input type="number" name="qty" value="1" min="1" max=$maxValue placeholder="
...
?>
                ...
                <a rel="facebox"
                    href="checkout.php?pt=<?php echo $_GET['id'] ?>&invoice=<?php echo $_GET['invoice'] ?>&total=<?php echo $fgfg ?>&totalprof=<?php echo $asd ?>&cashier=<?php echo $username ?>"><button
                        class="btn btn-info btn-large btn-inline" style="width: 200px;"><i class="icon icon-save icon-large"></i>
                        CREDIT</button>
                </a>
                <a rel="facebox"
                    href="checkout.php?pt=<?php echo $_GET['id'] ?>&invoice=<?php echo $_GET['invoice'] ?>&total=<?php echo $fgfg ?>&totalprof=<?php echo $asd ?>&cashier=<?php echo $username ?>"><button
                        class="btn btn-success btn-large btn-inline" style="width: 700px;margin-left:100px"><i class="icon icon-save icon-large"></i>
                        CASH</button>
                </a>
